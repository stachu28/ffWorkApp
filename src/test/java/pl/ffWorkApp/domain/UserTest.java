...
public class UserTest {
    static void main(String[] args) {
        ...
        IndividualUser notStudent = new IndividualUser("user1@test.com", "Individual User 1");
        IndividualUser student = new IndividualUser("user2@test.com", "Individual User 2", 123456);
        System.out.println("First test user is: " + notStudent);
        System.out.println("Sedond test user is: " + student);

        System.out.println("\n* Company User Test *");
        CompanyUser companyUser = new CompanyUser("companyuser1@test.com", "Company User 1",
                "Company Name", "123456");
